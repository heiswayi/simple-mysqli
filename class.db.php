...

{
    ...
    function exists($table = '', $check_val = '', $params = array())
    {
        self::$counter++;
    ...
    function get_row($query, $object = false)
    {
        self::$counter++;
    ...
    function get_results($query, $object = false)
    {
        self::$counter++;
    ...
    function insert_safe($table, $variables = array())
    {
        self::$counter++;
    ...
    function insert_multi($table, $columns = array() , $records = array())
    {
        self::$counter++;
    ...
    function update($table, $variables = array() , $where = array() , $limit = '')
    {
        self::$counter++;
    ...
    function delete($table, $where = array() , $limit = '')
    {
        self::$counter++;
    ...
    function truncate($tables = array())
    {
        if (!empty($tables)) {
            $truncated = 0;
    ...
    function display($variable, $echo = true)
    {
        $out = '';
